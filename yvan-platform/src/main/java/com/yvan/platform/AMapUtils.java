...
public class AMapUtils
{
     ...
     * @return
     */
    public static Integer calculateLineDistance(LngLat start, LngLat end)
    {
        ...
        return getInt(Math.asin(d14 / 2.0D) * 12742001.579854401D);
    }
     ...
     * @return
     */
    public static Integer getInt(double number){
